...
var dbClient = null;
var clientInstance = new _mongodb.MongoClient(MONGODB_URI, {
  serverApi: {
...
var GET_DB = exports.GET_DB = function GET_DB() {
  if (!dbClient) throw new Error("Database not connected. Call CONNECT_DB first.");
  return dbClient;
};